...
>(function Input(
  { className, type = "text", leftIcon, rightIcon, error, size = "md", describedBy, ...props },
  ref
) {
  const sizeStyles = {
    sm: "h-8 text-sm px-2",
    ...
    <div className="relative w-full group">
      ...
      <input
        ...
        className={cn(
          ...
          // 错误状态
          error && "border-red-500 focus:border-red-500 focus:ring-red-200 focus:shadow-sm",
          className
        )}
        {...props}
      />
      ...
      {rightIcon && (
        <div
          className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none transition-colors"
          aria-hidden="true"
        >
          {rightIcon}
        </div>
