    ...
    return (
        ...
        <section className="flex-1 overflow-y-auto p-6 bg-white space-y-4 max-w-2xl mx-auto">
            ...
            {todos.map(todo => (
                ...
                <Card key={todo.id} className="flex items-center justify-between rounded-md border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-150">
